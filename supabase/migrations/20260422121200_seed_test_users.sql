...
INSERT INTO users_metadata (id, role, plan, max_searches_per_day, default_results)
VALUES
  ('11111111-1111-1111-1111-111111111111', 'admin', 'enterprise', 100, 50),
  ('22222222-2222-2222-2222-222222222222', 'user', 'free', 20, 20)
